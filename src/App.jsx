    ...
    <div className="space-y-20">
      <header className="items-center">
        ...
        <div>
          ...
          <p className="text-sm mb-4">I studied Mathematics at Stanford. As an undergraduate, I was on <ExternalLink href="https://www.tesla.com/fsd">Andrej Karpathy's AI Team</ExternalLink> at Tesla and helped create <ExternalLink href="https://cs236g.stanford.edu">Stanford's PhD-level GANs class</ExternalLink>. I was later a founding researcher at <ExternalLink href="https://www.theinformation.com/briefings/exclusive-google-acquires-3d-image-generator-startup">CSM, acquired by Google DeepMind</ExternalLink>. My AI research has spanned robotics, 3D, self-driving, speech, NLP, computer vision, reinforcement learning, and self-supervised learning.</p>
        </div>
      </header>
      <section>
